...
- [성직자 응급 치유 재조정 구현 계획](superpowers/plans/2026-08-26-lattebun-cleric-emergency-heal-rebalance.md): 전투당 제한 제거와 대상 최대 HP 25% 회복을 타입·전투·U5·paired 백테스트에 반영하는 후속 테스트 우선 실행 순서
