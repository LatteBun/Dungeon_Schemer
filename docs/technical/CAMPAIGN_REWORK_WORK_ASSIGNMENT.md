...
지금 **37개가 끝났고 6개가 남았다.** 문서·기반·캠페인 규칙·탐험 규칙이 모두 완료됐고, 남은 것은 화면 하나(`U6`)와 마감 다섯이다.
...
`U6`는 이 줄과 나란히 간다. 선행 `C4`~`C8`이 모두 끝나 지금 이어붙일 수 있고,
`I2`가 그것을 기다린다.

지금 **선행 없이 시작할 수 있는 것은 `U6`와 `I1` 둘**이다. 나머지는 앞이
끝나야 열린다.
