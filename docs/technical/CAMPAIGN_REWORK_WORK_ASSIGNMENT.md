...
| C4 | 정산·위험도 상승 | SettlementSnapshot 검증, 생존 3/2/1명 보상, 전멸 손실·유품, 위험도 +1/★5 상한, 누적 골드와 SettlementResult 반영 | — | **C5 C6 C8 U6** |  | ⬜ |
| C5 | 승급 | 명성 60/120/200 무료 승급과 골드 150/320/600 승급, 수동 승급·강등 없음 | C4 | **C7 U6** |  | ⬜ |
| C6 | 엔딩·신뢰 0 누적 | 엔딩 5종 우선순위, 응급 후보 평가 뒤 인력 소진, 신뢰 0 누적 2~4명 수용·적발 보정, 5명 즉시 누적 고발 | C4 | **C7 U6** |  | ⬜ |
| C7 | 캠페인 전이·백테스트 | 정산 ID 중복 거부를 포함한 게시판부터 엔딩까지 순수 전이, 의도 3종×추론 정확도 2종×10,000시드 보고서, 생성 오류/시작 진행 불가 0건 | C5 C6 | **B1 I1** |  | ⬜ |
| C8 | 캠페인 통계 | SettlementResult를 재계산하지 않고 조언·반응, 생환·전멸, 전환점, 원정 연대기와 정산 원인 사슬을 캠페인 상태에 누적 | C4 | **U6** |  | ⬜ |
