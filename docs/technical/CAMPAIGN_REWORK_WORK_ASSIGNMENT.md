...
| B1 | 밸런스 재측정 | **B1-A 완료:** 실제 Store calibration으로 전 조합 완주율 0%와 정확도 효과 부재를 재현했다. **B1-B 진행:** 재도전 전투 scaling·월드턴·공통 보스 단계·원정 조언 압력을 조정하고 3전략×2정확도의 승인된 완주율·전멸 기준을 새 calibration과 독립 holdout에서 만족한다. 오류·거부·정체·비결정성은 0건이어야 한다 | — | **Q1** | LatteBun | 🟡 |
