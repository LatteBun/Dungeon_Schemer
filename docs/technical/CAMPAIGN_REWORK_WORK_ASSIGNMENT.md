...
| D2 | 캐릭터·풀 문서 | `PARTY_AND_TRUST.md`가 캐릭터·신뢰 문서와 풀·월드턴 문서로 분할되고, 풀 30명·임시 편성·휴식·백그라운드·중상·신뢰 0 누적표가 확정 수치로 적힘 | D1 | **D6 F1 F4** | sbh3821 | ⬜ |
| D3 | 던전·테마·정보 문서 | 초기 위험도별 6~8 지점표, 재도전 규칙, 위험도별 정보 기회표, 테마 3종의 생태 규칙 계약이 적히고, 선택 전 카드 유형·발각 위험을 보여준다는 조항이 삭제됨 | D1 | **D6 F2 F3 F5** | SangHwan Yoo | ⬜ |
