...
| D4 | 성장·엔딩 문서 | 위험도별 보상표, 명성 시작 30·하한 0, 명성 승급과 골드 승급표, 엔딩 6종과 판정 순서가 적히고 승급 점수 공식이 삭제됨 | — | **C5 C6 D6** | SangHwan Yoo | ⬜ |
...
| U6 | 정산·승급·엔딩 화면 | 정산이 원인 순서로 나열되고 위험도와 보상 변화가 함께 표시되며, 승급하기 버튼으로 명성·골드 승급을 고를 수 있고 엔딩 6종이 판정 원인과 누적 통계와 함께 표시됨 | U1 C4 C5 C6 C8 | **I2** | LatteBun | ⬜ |
