...
| M2 | 전역 오디오·퀵 메뉴 | 기본 OFF인 공통 BGM·UI 효과음을 V1 브라우저 설정으로 독립 저장하고 route 전환에도 같은 BGM 재생 위치를 유지한다. 모든 앱 화면의 우측 상단 메뉴에서 설정과 캠페인을 보존하는 업적 overlay를 열며, 독립 업적 route는 안전한 이전 화면 복귀를 제공한다 | — | — | sbh3821 | ✅ |
