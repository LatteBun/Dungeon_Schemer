...
| F3-5 | 테마 전용 사건 확장 | 테마마다 전용 사건이 30개로 늘고 규칙별 도움·방해 공급과 테마별 중립 공급을 그대로 만족 | — | — |  | ⬜ |
...
| 테마별 조언 콘텐츠 | 거미굴·사막·묘지 전용 대표 콘텐츠를 테마당 20개씩 제공하고 활성 규칙별 유형 조합과 단서·강한 연계를 채운다 | `F3-2` `F3-3` |
