...
분류를 합치면서 상인 주제 정보 카드 6장이 죽을 뻔해 `DungeonEvent.infoSubject`를 더했다. 사건이 주제를 직접 선언하므로 상인 조우 사건은 상인 카드를 계속 제시한다. 특수 사건의 기본 피해는 상인이 0이었으므로 -12에서 **0**으로 낮췄다.
...
| E1 | 등급별 지도·정보 기회 생성 | 7/9/11/13 지점 대칭 지도와 모든 경로의 C2/B3/A4/S5 정보 횟수 테스트 통과 | — | **C5 E2 U2** | sbh3821 | ✅ |
...
| U2 | 지도·정보·사건 화면 | 공개 지도, 조언 기회, 개인 반응과 사건 결과 흐름 동작 | — | **I1** | LatteBun | ✅ |
