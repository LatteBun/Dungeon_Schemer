...
| C5 | 공고·계약 위험 요약 | 게시판의 공고마다 사건 분류별 위험 요약이 나오고, 계약 확인에서 분류별 개수를 보여준다. 지도 생성 시드가 탐험과 일치 | — | — |  | ⬜ |
...
| Q1 | 접근성·전체 검증 | 키보드 조작, 색상 외 단서, 변화 사유, lint·typecheck·test·build와 브라우저 검증 통과 | **U4** | **Q2** |  | ⬜ |
