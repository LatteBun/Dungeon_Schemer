...
캠페인 화면 일곱 장과 캠페인 밖 메타 화면 두 장, 모두 아홉 장이다. **구현된
...
- `/`에서 캠페인 시작과 업적 기록의 두 실제 링크를 제공한다.
- 업적 기록 링크는 이 브라우저에서 달성한 수를 함께 보여준다.

### 길잡이 업적 기록

[![길잡이 업적 기록](png/screen-achievements.png)](png/screen-achievements.png)

- `/achievements`에서 결과형·누적형 업적 여덟 장을 4열×2행으로 보여준다.
- 잠금·해금 상태, 공개 누적 진행도, 저장 상태를 색과 문구로 함께 구분한다.
- 메인 메뉴로 돌아갈 수 있고, 확인 대화상자를 거쳐 이 브라우저의 기록만 초기화한다.
